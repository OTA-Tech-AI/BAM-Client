...
from browser_use.agent.page_content_cleaning import cleanup_page_symbol_content
...
class AgentMessagePrompt:
	...
	def get_user_message(self, use_vision: bool = True, concurrent_agent_id="") -> HumanMessage:
		...
		elements_text = cleanup_page_symbol_content(elements_text, concurrent_agent_id)
